...
export function layout() {
  return (
    (<div key="1" className="flex flex-col min-h-screen">
      <div
        className="flex items-center justify-between px-4 py-2 bg-white dark:bg-gray-800 sm:px-6">
        ...
        <NavigationMenu className="hidden lg:flex">
          <NavigationMenuList>
            ...
            <NavigationMenuItem>
              <NavigationMenuTrigger className="px-4 py-2">Services</NavigationMenuTrigger>
      ...
      <footer
        className="flex flex-col gap-4 py-6 px-4 bg-white dark:bg-gray-800 sm:px-6 lg:flex-row lg:gap-6">
        ...
        <div className="space-y-4 lg:w-1/4">
          ...
          <form className="flex flex-col space-y-2">
            <Input className="max-w-md" placeholder="Enter your email" type="email" />
...
function MilkIcon(props) {
  return (
    (<svg
      ...
      <path d="M8 2h8" />
      <path
        d="M9 2v2.789a4 4 0 1-.672 2.219l-.656.984A4 7 10.212V20a2 2 2h6a2 2-2v-9.789a4 0-.672-2.219l-.656-.984A4 1 15 4.788V2" />
